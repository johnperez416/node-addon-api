...
## [9.0.0](https://github.com/johnperez416/node-addon-api/compare/v8.9.2...v9.0.0) (2026-09-02)


### ⚠ BREAKING CHANGES

* bump minimum supported Node.js version to 22 ([#1751](https://github.com/johnperez416/node-addon-api/issues/1751))

### Features

* add Date::New overload for a std::chrono::system_clock::time_point ([#1705](https://github.com/johnperez416/node-addon-api/issues/1705)) ([7fb063d](https://github.com/johnperez416/node-addon-api/commit/7fb063d95ff5ef816d1616f9acf4afac854cfd4c))
* add Object::GetPrototype and Object::SetPrototype ([#1715](https://github.com/johnperez416/node-addon-api/issues/1715)) ([967bbd5](https://github.com/johnperez416/node-addon-api/commit/967bbd5911c7e90b428d4769b9ab1b1a0cee4451)), closes [#1691](https://github.com/johnperez416/node-addon-api/issues/1691)
* add Object::New overload utilizing node_api_create_object_with_properties ([#1735](https://github.com/johnperez416/node-addon-api/issues/1735)) ([06d56f7](https://github.com/johnperez416/node-addon-api/commit/06d56f74e1dc34166fed174b6e747bcd835ba684))
...
* add std::string_view overload for Symbol::For ([#1722](https://github.com/johnperez416/node-addon-api/issues/1722)) ([f65113b](https://github.com/johnperez416/node-addon-api/commit/f65113b6ce54271b0a26f97fc624b5574b64a048))
* add String::New overload for string_view ([#1706](https://github.com/johnperez416/node-addon-api/issues/1706)) ([0add130](https://github.com/johnperez416/node-addon-api/commit/0add1306f60b81432da94d13683aa0b06aa52925))
...
* add support for SharedArrayBuffer in DataViews ([#1714](https://github.com/johnperez416/node-addon-api/issues/1714)) ([7b8d69e](https://github.com/johnperez416/node-addon-api/commit/7b8d69e0ba912291aea0b337f7f1814b1032f7f0))
* add support for SharedArrayBuffer in TypedArray and TypedArrayOf&lt;T&gt; ([#1731](https://github.com/johnperez416/node-addon-api/issues/1731)) ([00b95ef](https://github.com/johnperez416/node-addon-api/commit/00b95efea6522980e9661a729a59b926ecf5c6b6))
...
* bump minimum supported Node.js version to 22 ([#1751](https://github.com/johnperez416/node-addon-api/issues/1751)) ([3075ace](https://github.com/johnperez416/node-addon-api/commit/3075ace9f154006d03c0b8f68850d54b55398eca))
...
* add missing const to ObjectReference::Set string parameter ([#1713](https://github.com/johnperez416/node-addon-api/issues/1713)) ([845ba8e](https://github.com/johnperez416/node-addon-api/commit/845ba8e4b0888ca20ed3f7c95f9d461cbce338c5))
* allow const vectors with Object::New overload utilizing node_api_create_object_with_properties ([#1755](https://github.com/johnperez416/node-addon-api/issues/1755)) ([25c6b21](https://github.com/johnperez416/node-addon-api/commit/25c6b211f0395b38a3a1230f15e9c523dca50fdb))
...
* fix -Wextra-semi ([#1718](https://github.com/johnperez416/node-addon-api/issues/1718)) ([7fef973](https://github.com/johnperez416/node-addon-api/commit/7fef9739166ebb89263459e9f4c3363678cd6367))
* fix vs2026 ICE compatibility ([#1739](https://github.com/johnperez416/node-addon-api/issues/1739)) ([7223518](https://github.com/johnperez416/node-addon-api/commit/722351807e21eaada1df16de1e959006c907a031))
...
* resolve Symbol::For overload ambiguity ([#1742](https://github.com/johnperez416/node-addon-api/issues/1742)) ([13c854a](https://github.com/johnperez416/node-addon-api/commit/13c854a1f57e754e5082a1961e0d32e8f0f96543))
